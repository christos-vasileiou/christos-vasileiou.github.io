    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ['christos-vasileiou/the-art-of-command-line'], // These projects will not be displayed. example: ['christos-vasileiou/my-project1', 'christos-vasileiou/my-project2']
        },
      },
      manual: {
